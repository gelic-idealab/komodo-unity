...
Category {
  ...
  SubShader {
    Pass {
      ...
      #pragma target 3.5 //Brandon changed this to 3.5 -- not sure if following comment is Komodo-specific -> // Required -> compiler error: too many instructions for SM 2.0
