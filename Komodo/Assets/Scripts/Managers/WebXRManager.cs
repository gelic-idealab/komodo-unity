...
namespace WebXR
{
    ...
    //since we use an update and lateupdate and we want to centralize all update calls to restrict calls between manage and native code (see GameStateManager.cs) we use this interface.
    public class WebXRManager : SingletonComponent<WebXRManager>, IUpdatable, ILateUpdatable
    {
        ...
        private void Awake()
        {
            //register our update loops
            GameStateManager.Instance.RegisterUpdatableObject(this);
            GameStateManager.Instance.RegisterLateUpdatableObject(this);
        ...
        public void OnStartXR() => Instance.SetXrState(WebXRState.ENABLED);
        
        // receive end VR from WebVR browser
        public void OnEndXR() => Instance.SetXrState(WebXRState.NORMAL);
        ...
        public void OnLateUpdate(float realTime)
        {
        ...
        private void OnDestroy()
        {
            ...
            if (GameStateManager.IsAlive)
            {
                ...
                GameStateManager.Instance.DeRegisterLateUpdatableObject(this);
            }
        }
